...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('cloud_topic', default_value="/livox_PointCloud2", description="a pointcloud topic to process",),
        DeclareLaunchArgument('cloud_frame', default_value="livox", description="a pointcloud topic to process",),
